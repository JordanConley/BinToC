...
/** 
 * @brief Creates an accompanying header file for the binary dump. Header file
 * contains an extern definition for the source file.
 * @param[in] outh A FILE* representing the header file to create.
 * @param[in] variable The name of the variable created by the utility.
 */
...
/**
 * @brief Creates the C source file for the binary dump.
 * @param[in] in The file containing the binary data.
 * @param[in] outc The C-source file be to generated.
 * @param[in] variable The name of the variable generated by the utility.
 */
